...
function verifPseudo($data) {
  ...
  if (preg_match($regex, $pseudo) == 1) {
    return preg_match($regex, $pseudo);
  }
  else {
    $resultat = "Invalid Pseudo!</br></br>- (requires) at least one lower case</br>- (requires) at least one upper case</br>- (requires) 3 characters minimum</br>- accents and numbers are allowed</br>- 100 characters Maximum";
    return $resultat;
  }
}
